...
Pod::Spec.new do |s|
  s.name             = 'FSNetwork'
  s.version          = '0.1.0'
  s.summary          = 'A short description of FSNetwork.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/wanqijian/FSNetwork'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'wanqijian' => 'wanqijian@icloud.com' }
  s.source           = { :git => 'https://github.com/wanqijian/FSNetwork.git', :tag => s.version.to_s }
